...
{
    public partial class TransActionPracticeContext : DbContext
    {
        public TransActionPracticeContext()
        {
        }

        public TransActionPracticeContext(DbContextOptions<TransActionPracticeContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TraUser>(entity =>
            {
                ...
                entity.HasIndex(e => e.RoleId)
                    .HasName("IX_FK_USER_ROLES");

                entity.HasIndex(e => e.TeamId)
                    .HasName("IX_FK_UserTEAM");
