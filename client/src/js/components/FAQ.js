...
const faqItems = [
  ...
  {
    q: 'How is TransAction Wellness different from TransAction: Healthy Workplace Challenge occurring each October?',
  ...
  },
  {
    ...
    a:
      'Activities completed between June 1-30 can be entered until 4:30 p.m. on Friday, July 3. Try your best to enter your activities daily or at least every week so that your teammates can see your progress.',
  },
];
