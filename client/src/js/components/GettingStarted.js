...
const GettingStarted = ({ currentUser }) => {
  ...
  const showCreateTeamFormHandler = () => {
    setShowCreateTeamForm(true);
  };

  const toggleCreateTeamForm = () => {
    setShowCreateTeamForm(prevState => !prevState);
  };
    ...
    <CardWrapper>
      <Row>
        <Col>
          ...
          <strong>Competitive</strong> and <strong>Recreational</strong>.
          <p />
          <ul>
            <li>
              ...
              <Card>
                ...
                <CardBody>
                  <p>
                    ...
                    Information, where you can name and pick your teammates from the selection pool. Contact your
                    potential team members so you can "pick them up" as soon as they register. Create a unique team
                    profile. Go crazy.
                  </p>
                </CardBody>
                <CardFooter className="text-center">
                  <Button color="primary" onClick={showCreateTeamFormHandler}>
                    Create Team
                  </Button>
                </CardFooter>
              </Card>
              <Card>
                ...
                <CardBody>
                  <p>
                    ...
                    Selection Pool. Once you've done that, contact your leader and tell them to "get me the heck on your
                    team". Your leader, being the highly efficient, motivated coach they are, will immediately "pick
                    you up". Of course, sending a basket of fruit may help speed up this process. Free Agents can get
                    picked up by any Team Leader anywhere in the ministry.
                  </p>
                </CardBody>
                <CardFooter className="text-center">
    ...
    <React.Fragment>
      ...
      {showCreateTeamForm && (
        <EditTeamForm
          ...
          toggle={toggleCreateTeamForm}
          initialValues={{ goal: 0, regionId: currentUser.regionId }}
